...
public class BoardController {
    ...
    @RequestMapping("/board/writeDo")
    public String boardWriteDo(@ModelAttribute Board board, Model model, MultipartFile file) throws IOException {
